...
def DirectoryScanner(DirectoryPath):
    ...
    LogFileName = LogFileName.replace(" ","_")      #to replace the _ in filename
    ...
    Ret = os.path.isdir(DirectoryPath)  #to check if direcctory is this
    ...
    fobj.write(Border+"\n")
    fobj.write("Log file gets created at: "+timestamp)  #concatenate
    fobj.write("\n"+Border+"\n")
